...
public class FunctionLibrary {
		...
		try {
			...
			if (TestAttributes.AutomationApp.trim().equalsIgnoreCase("MOBILE")) {				
				...
				*/
				...
				cap.setCapability("udid", getConfigValue("UDID"));
				cap.setCapability("deviceName", getConfigValue("Device"));
				cap.setCapability("platformName", getConfigValue("Device OS"));
				cap.setCapability("platformVersion", getConfigValue("Device OS Version"));
				cap.setCapability("appPackage", getConfigValue("Package"));
				cap.setCapability("appActivity", getConfigValue("Activity"));
				TestAttributes.mobiledriver = new AppiumDriver<>(new URL(getConfigValue("Host")),cap);
				System.out.println("Mobile driver started");
				Thread.sleep(10000);
			}
		} catch (Exception e) {
	...
	public static void getAutomationApp(){
		...
		if(TestAttributes.AutomationTool.equalsIgnoreCase("APPIUM"))
			TestAttributes.AutomationApp = "MOBILE";
	}
